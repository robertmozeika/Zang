var categoryAnimal = (function(){
var  animalGenerator = {

    init: function(){
        animalGenerator.youtubeChange()
    },

    bind: function(){
      events.on('categoryAnimal', this.init)
    },
    ...
    youtubeChange: function(){
      ...
      player2.cuePlaylist({listType:"search",
                list: "facts " + resultBox.selection,
                videoCategoryID: 'Education',
                startSeconds:0,
                suggestedQuality:"default"});
      }
        ...
        setTimeout(animalGenerator.youtubeChange, 700)
      }


    }
  }
  animalGenerator.bind()
  })()



var animalQuickFacts = (function(){
  var animalQF = {
    joinedFeedFacts: [],
    obj_FeedFacts: [],
    clData: 0,
    ...
    bind: function(){
      events.on('categoryAnimal', this.init.bind(this))
    ...
    lifeSpan: function(){
      $.getJSON("ALong.json", function(DTA){
       ...
       var tester2 = new RegExp("(" + resultBox.selection +")", "gi")
